...
public class CustomerController {
    ...
    public void load() {
        try {
            File file = new File("C:\\mycode\\OOP\\OnlineShop\\src\\ro\\mycode\\data\\customer.txt");
    ...
    public Customer findCustomerConectare(String email, String pass){
        for(int i=0; i<customers.size();i++){
